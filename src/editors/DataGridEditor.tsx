...
export class DataGridEditor extends Component<Props, State> {
  ...
  onChange = debounce(100, (data: any) => {
    // Use type assertion to handle the updated Matrix type from react-spreadsheet
    const grid = data as GridCellItem[][];
    this.setState({ grid }, () => this.updateSourceItemsByDataGrid());
  });
